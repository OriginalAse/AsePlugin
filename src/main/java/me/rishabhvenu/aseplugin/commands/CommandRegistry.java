package me.rishabhvenu.aseplugin.commands;
...
public class CommandRegistry implements CommandExecutor {
        ...
        for (int i = -1; i <= args.length - 1; i++) {
            ...
            for (String usage : registeredCommandTable.keySet()) {
                if (usage.equals(sb.toString())) {
                    ...
                    Command annotation = wrapper.annotation;
                    ...
                    */
                    ...
                    if (actualParams.length > 0 && registeredCommandTable.containsKey(usage + " " + actualParams[0])) {
                        wrapper = registeredCommandTable.get(usage + " " + actualParams[0]);
                    ...
                    if (actualParams.length != annotation.parameters() && !annotation.overrideParameterLimit()) {
                        ...
                        else failureHandler.handleFailure(CommandFailReason.INSUFFICIENT_PARAMETER, sender, wrapper);
                        return true;
                    }
     ...
     */
    public final static class RegisteredCommand {
